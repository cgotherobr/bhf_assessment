...
: ${AMENT_CURRENT_PREFIX:="/bhf_assessments/install/bhf_vo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bhf_vo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bhf_vo/environment/path.sh"
